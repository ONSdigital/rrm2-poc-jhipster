...
import uk.gov.ons.rrm.domain.PersistentToken;
import uk.gov.ons.rrm.domain.User;
import uk.gov.ons.rrm.repository.PersistentTokenRepository;
import uk.gov.ons.rrm.repository.UserRepository;
import uk.gov.ons.rrm.security.SecurityUtils;
import uk.gov.ons.rrm.service.MailService;
import uk.gov.ons.rrm.service.UserService;
import uk.gov.ons.rrm.service.dto.UserDTO;
import uk.gov.ons.rrm.web.rest.vm.KeyAndPasswordVM;
import uk.gov.ons.rrm.web.rest.vm.ManagedUserVM;
